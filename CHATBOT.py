...
def mostrar_sidebar():
    ...
    modelo = st.sidebar.selectbox("A cual eliges?", MODELOS,index=0)
...
if __name__ == '__main__': # Si este archivo es el archivo principal , entonces EJECUTÃ¡
    ejecutar_app()
